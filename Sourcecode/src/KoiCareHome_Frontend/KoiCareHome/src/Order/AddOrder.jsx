...
//                 <div className="form-group">
//                     <label>Order Date:</label>
//                     <input type="datetime-local" name="orderDate" value={order.orderDate} onChange={handleChange} required />
//                 </div>
//                 <div className="form-group">
//                     <label>Sub Amount:</label>
//                     <input type="number" name="subAmount" value={order.subAmount} onChange={handleChange} required />
...
//                     <input type="number" name="vatAmount" value={order.vatAmount} onChange={handleChange} required />
//                 </div>
//                 <div className="form-group">
