...
public class FishService {
    ...
    public Fish saveFish(Fish fish) {
        if (fishRepository.existsByNameAndPondIdExceptId(fish.getName(), fish.getPondID(), fish.getFishID())) {
...
//    }
    ...
    public Fish updateFish(int id, Fish updatedFish) {
        ...
        } else if (fishRepository.existsByNameAndPondIdExceptId(updatedFish.getName(), updatedFish.getPondID(), id)) {
