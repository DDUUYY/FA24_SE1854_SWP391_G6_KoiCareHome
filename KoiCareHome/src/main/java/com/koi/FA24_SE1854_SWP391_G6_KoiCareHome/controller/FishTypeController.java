...
public class FishTypeController {
     ...
     * @return the ResponseEntity with status 200 (OK) and with body of the FishType, or with status 404 (Not Found) if the FishType does not exist
     */
    @GetMapping("/{id}")
     ...
     * @return the ResponseEntity with status 200 (OK) and with body of the updated FishType, or with status 404 (Not Found) if the FishType does not exist
     */
    @PutMapping("/{id}")
